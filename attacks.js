...
()
14: ilovehashtags
(S,4,4,30,3)(S,4,3,30,1)(S,6,3,30,1)(S,7,4,30,1)(S,7,6,30,1)(S,4,7,30,1)(S,6,7,30,1)(S,3,6,30,1)(S,3,4,30,1)
()
(C,5,3,30)(C,3,5,30)(C,5,7,30)(C,7,5,30)
()
()
()
()
...
()
15: heatseeking
(M,1,$,Right)(M,9,$,Left)(M,#,1,Down)(M,#,9,Up)
()
()
()
((M,1,$,Right)(M,9,$,Left)(M,#,1,Down)(M,#,9,Up))
...
(E,4,4,30)(E,4,6,30)(E,6,4,30)(E,6,6,30)
()
()
()
()
...
()
26: spotlights
(W,3,vertical,2,1)(W,6,vertical,2,1)(W,9,vertical,2,1)
()
(W,2,vertical,2,1)(W,5,vertical,2,1)(W,8,vertical,2,1)
()
(W,1,vertical,2,1)(W,4,vertical,2,1)(W,7,vertical,2,1)
()
(W,3,vertical,2,1)(W,6,vertical,2,1)(W,9,vertical,2,1)
()
(W,2,vertical,2,1)(W,5,vertical,2,1)(W,8,vertical,2,1)
...
()
27: dittobutsideways
(W,3,horizontal,2,1)(W,6,horizontal,2,1)(W,9,horizontal,2,1)
()
(W,2,horizontal,2,1)(W,5,horizontal,2,1)(W,8,horizontal,2,1)
()
(W,1,horizontal,2,1)(W,4,horizontal,2,1)(W,7,horizontal,2,1)
()
(W,3,horizontal,2,1)(W,6,horizontal,2,1)(W,9,horizontal,2,1)
()
(W,2,horizontal,2,1)(W,5,horizontal,2,1)(W,8,horizontal,2,1)
...
class bobby {
    ...
    interpret(){
      if (startup == 5){
        ...
        if (this.tick == 32){
          this.load(Randint(40)+1);
          if ((variant == "shadowme" || variant == "strikes") && this.curattack == 39){
            this.load(38);
          }
        }
        if (this.tick == 33){
